...
#define AS_SMALL_STRING(value) ((value).as.smallString.data)
#define SMALL_STRING_LEN(value) ((value).as.smallString.length)

#define AS_CSTRING(value) \
    (IS_SMALL_STRING(value) ? AS_SMALL_STRING(value) : AS_STRING(value)->chars)
